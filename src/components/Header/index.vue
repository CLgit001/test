<template>
    <div class="body">
        <div class="headr">
            <div class="logo" @click="navgo('http://test.shadou.cn/index.html')">
                <img src="../../images/logoa.png">
            </div>
            <div class="head_cont">
                <div class="txt" @click="navgo('http://shadou.cn/index.html')">首页</div>
                <div class="txt" @click="navgo('http://test.shadou.cn/type.html')">创意分类</div>
                <div class="txt" @click="navgo('http://test.shadou.cn/buy.html')">订购</div>
                <div class="txt" @click="navgo('http://test.shadou.cn/case.html')">行业案例</div>
                <div class="user">
        ...
        methods:{
            ...
            navgo(e){
                if(e){
                    console.log(e)
                    this.mous=false
                    self.location.href = e //(e,'self')
                }else {
                    localStorage.removeItem('jwt_token')
                    window.open("http://test.shadou.cn/?exit="+0) ;
